...
public class Offer_4_ReBuildBinaryTree {
    public static void main(String[] args) {
        ...
        TreeNode<Integer> node = rebuildBinaryTree1(pre, mid);
    ...
    public static TreeNode<Integer> rebuildBinaryTree1(int[] pre, int[] mid) {
        if (pre == null || mid == null) return null;
        return rebuildBinaryTree1(pre, 0, pre.length - 1, mid, 0, mid.length - 1);
    }

    public static TreeNode<Integer> rebuildBinaryTree1(
         ...
         */
        node.left = rebuildBinaryTree1(pre, startPre + 1, startPre + len, mid, startMid, i - 1);
        node.right = rebuildBinaryTree1(pre, startPre + 1 + len, endPre, mid, i + 1, endMid);
